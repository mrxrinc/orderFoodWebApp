...
import { restaurantSearch, restaurantListTag ,restaurantSearchChain} from '../../api/application/restaurant';
...
class RestaurantsList extends React.Component {
  constructor(props) {
    ...
    this.state = {
      loading: true,
      restaurantList: [],
      restaurantSlug: props.match.params.slug,
      searchTerm: '',
      filters: [],
      restaurantListTag: {},
      filterShow: false,
  ...
  componentDidMount() {
    ...
    this.fetchRestauranList(this.state.restaurantSlug)
  }

  fetchRestauranList = (restaurantSlug) => {
    restaurantSearchChain(
      restaurantSlug,
  ...
  onFilterValidation = (value) => {
    const { restaurantSlug } = this.state;
    if (value) {
      this.setState({ filterValidation: true }, () => {
        this.fetchRestauranList(restaurantSlug);
        this.toggleModal();
      })
    } else {
      this.setState({
